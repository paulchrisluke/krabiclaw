  ...
  switch (name) {
    ...
    case "triage_inbox": {
      return {
        ...
        text: [
          "Call get_contact_inquiries and get_reservation_inquiries to find new/unread submissions, and list_experience_bookings (per location if the site has more than one) to find pending bookings.",
