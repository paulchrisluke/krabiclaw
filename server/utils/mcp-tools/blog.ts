...
export const BLOG_TOOLS: McpToolDefinition[] = [
  ...
  siteTool({
      ...
      inputSchema: {
        ...
        guidance_run_id: { type: 'string', description: 'Completed blog.write review run returned by review_blog_draft_against_guidance for this exact draft.' },
  ...
  siteTool({
      ...
      inputSchema: {
        ...
        guidance_run_id: { type: 'string', description: 'Required with content_blocks. Completed blog.write review run returned by review_blog_draft_against_guidance for this exact replacement draft.' },
  ...
  siteTool({
      ...
      inputSchema: {
        ...
        guidance_run_id: { type: 'string', description: 'Completed blog.write review run returned by review_blog_draft_against_guidance for this exact replacement draft.' },
      },
