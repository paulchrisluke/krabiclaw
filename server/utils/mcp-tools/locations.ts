...
export const LOCATIONS_TOOLS: McpToolDefinition[] = [
  ...
  siteTool({
      ...
      description: 'Assign a saved video asset as a location hero video. Upload the video first via upload_user_media with a native ChatGPT attachment, then pass its asset id here. Hero videos take display priority over any existing hero image for the same location.',
      domain: 'locations',
      minimumRole: 'editor',
      confirmRequired: false,
      inputSchema: {
