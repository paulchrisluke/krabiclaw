...
export const EXPERIENCES_TOOLS: McpToolDefinition[] = [
  ...
  siteTool({
      name: 'list_bookings',
      description: 'List bookings for one specific experience, including each guest\'s name, email, and phone number. Use list_all_bookings instead when the user asks about bookings across the whole site, not just one experience.',
      domain: 'experiences',
      minimumRole: 'editor',
      confirmRequired: false,
