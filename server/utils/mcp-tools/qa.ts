...
export const QA_TOOLS: McpToolDefinition[] = [
  siteTool({
    name: 'list_site_qa',
    description: 'List tenant-wide Q&A that is not associated with a location.',
    domain: 'qa',
    minimumRole: 'editor',
  ...
  siteTool({
    name: 'create_site_qa',
    description: 'Create a tenant-wide Q&A pair.',
    domain: 'qa',
    minimumRole: 'editor',
    confirmRequired: false,
    inputSchema: { question: { type: 'string' }, answer: { type: ['string', 'null'] }, status: { type: 'string', enum: ['published', 'hidden'] } },
    required: ['question'],
  ...
  siteTool({
    ...
    minimumRole: 'editor',
    confirmRequired: false,
    inputSchema: { qa_id: { type: 'string' }, question: { type: 'string' }, answer: { type: ['string', 'null'] }, status: { type: 'string', enum: ['published', 'hidden'] }, sort_order: { type: 'number' } },
    required: ['qa_id'],
  ...
  siteTool({
    ...
    minimumRole: 'editor',
    confirmRequired: false,
    inputSchema: { updates: { type: 'array' } },
    required: ['updates'],
