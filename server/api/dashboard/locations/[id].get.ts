...
export default defineHandler(async (event) => {
  ...
  const capabilitySummary = await resolveLocationCapabilitySummary(db, organizationId, location.organization_id, location.feature_overrides as string | null ?? null)
