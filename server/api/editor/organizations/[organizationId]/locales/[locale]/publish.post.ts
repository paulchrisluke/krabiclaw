...
import { publishOrganizationLanguage } from '~/server/utils/organization-languages'
...
export default defineHandler(async (event) => {
  ...
  return { language: await publishOrganizationLanguage(db, env, { organizationId: organization.id, locale }) }
})
