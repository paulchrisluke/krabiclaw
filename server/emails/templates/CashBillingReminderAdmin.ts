...
// Brand constants (must match EmailShell)
const FG = '#1F2547'
const FG_MUTED = '#4A5380'
  ...
  setup(props) {
    return () => {
      ...
      return h(EmailShell, {
        ...
        h(EText, {
          style: `margin:0 0 16px;font-size:26px;font-weight:800;color:${FG};letter-spacing:-0.5px;line-height:1.15`,
        }, () => `Cash collection: ${props.siteName}`),
        h(EText, {
          style: `margin:0 0 20px;font-size:15px;color:${FG_MUTED};line-height:1.6`,
        ...
        h(ESection, {
          ...
          h(EText, { style: `margin:0 0 12px;font-size:15px;font-weight:600;color:${FG}` }, () => props.clientEmail),
          ...
          h(EText, { style: `margin:0 0 12px;font-size:24px;font-weight:800;color:${FG}` }, () => amount),
          ...
          h(EText, { style: `margin:0;font-size:15px;font-weight:600;color:${FG}` }, () => props.periodEnd),
        ]),
      ])
    }
  },
