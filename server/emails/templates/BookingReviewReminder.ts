...
export default defineComponent({
  ...
  setup(props) {
    return () => h(EmailShell, {
      preheader: `${props.siteName} is still hoping for your feedback`,
      title: `A quick reminder from ${props.siteName}`,
      siteName: props.siteName,
      platformDomain: props.platformDomain,
    }, () => [
      h(EText, { class: 'email-text', style: 'margin:0 0 16px;font-size:15px;color:#52525b;line-height:1.6' }, () => `Hi ${props.guestName}, thanks again for visiting. If you have a minute, your review helps ${props.siteName} improve and helps future guests know what to expect.`),
      h(EmailDetails, {
        rows: [
