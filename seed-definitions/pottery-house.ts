...
export const potteryHouseFixture: CuratedSiteDefinition = {
  ...
  locationQa: [
    ...
    },
    {
      ...
      questionAuthor: 'A Guest',
      answer:
        'The beachfront session at Klong Muang runs on selected days with very limited seats (maximum 4 guests). Message us on Instagram @potteryclasseskrabi to check availability.',
      answerAuthor: 'Pottery House Krabi',
      isOwnerAnswer: true,
      upvoteCount: 16,
      source: 'manual',
...
export function renderCompiledPotteryHouseExperiencesBlock(): string {
  ...
  const experiencePriceRows = compiledPotteryHouseSeed.experiences
    ...
    .map(experience => `  (${[
      ...
      sqlValue(compiledPotteryHouseSeed.site.defaultCurrency), sqlValue('person'), sqlValue('unspecified'), 'NULL',
      sqlValue('2026-01-01T00:00:00.000Z'), 'NULL', sqlValue('template'), sqlValue('seed:pottery-house'),
