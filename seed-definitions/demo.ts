...
export const demoFixture: CuratedSiteDefinition = {
  ...
  mediaAssets: [
    ...
    // Loc-demo: hero + video assets
    {
      ...
      source: 'external',
      publicUrl: '/demo/ember-slice-brooklyn-interior.png',
      thumbnailUrl: '/demo/ember-slice-brooklyn-interior.png',
      mimeType: 'image/png',
      fileName: 'ember-slice-brooklyn-interior.png',
      altText: 'Warm Brooklyn pizzeria dining room with a wood-fired oven',
      category: 'interior',
    },
    {
