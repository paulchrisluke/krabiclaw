...
async function main() {
  ...
  if (!fixturePassword || fixturePassword === LOCAL_DEVELOPER_PASSWORD) {
    throw new Error('A non-default E2E_TEST_PASSWORD is required before exposing the local app through a public tunnel.')
  }
