...
// `wrangler d1 execute --file` has been observed to intermittently fail on
// this seed with "Not currently importing anything" (see wrangler-retry.ts)
// — kikuzuki's seed is by far the largest of the three (~80KB vs ~40-55KB
// for pottery-house/demo), and splitting it into smaller sequential applies
// keeps each individual import well under whatever threshold triggers it,
// same fix already proven against migrations/0021 in prod/staging/preview.
