...
async function authHeaders() {
  ...
  return credentialSession(BASE_URL, { userId: process.env.MCP_E2E_USER_ID || 'user-e2e-platform-admin' })
}
...
async function main() {
  ...
  if (!headers) {
    skip('authenticated checks need MCP_BEARER_TOKEN, local credentials, or MCP_CREDENTIAL_LOGIN=1')
