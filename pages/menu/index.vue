...
useSocialMetadata(() => ({ path: presentation.collectionPath, title: `${brandName} Menu`, description: `Full menu at ${brandName}.`, label: presentation.collectionLabel, brand: { siteName: brandName }, ownerType: 'site', ownerId: `${siteId}:menu` }))
</script>
