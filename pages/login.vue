  ...
  <div class="flex-1 grid lg:grid-cols-2">
    ...
    <div class="flex items-center justify-center px-8 py-12">
        <div class="w-full max-w-105">
          <h1 class="text-[36px] font-extrabold tracking-tight text-(--kc-navy) m-0 mb-2">Welcome back</h1>
          <p class="text-[15px] text-(--kc-navy-500) mb-7">Sign in to manage your restaurant.</p>
          ...
          <div class="space-y-3">
            ...
            <div v-else-if="otpStep === 'code'" class="space-y-3">
              <p class="text-sm text-(--kc-navy-500)">
                A 6-digit code was sent to <strong class="text-(--kc-navy)">{{ phone }}</strong> on WhatsApp.
              </p>
              ...
              <button class="w-full text-sm text-(--kc-navy-300) hover:text-(--kc-navy) transition-colors" @click="otpStep = 'phone'; code = ''; error = null">
