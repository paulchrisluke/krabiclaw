<template>
  <UPage class="relative overflow-hidden bg-default min-h-screen py-20 lg:py-28">
    ...
    <UPageBody class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
