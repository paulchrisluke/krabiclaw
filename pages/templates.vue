    ...
    <div class="container mx-auto px-4 py-16">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
          <h1 class="text-5xl font-bold text-[var(--ui-text-highlighted)] mb-6">Beautiful Restaurant Themes</h1>
          <p class="text-xl text-[var(--ui-text-muted)] max-w-3xl mx-auto">
        ...
        <!-- Featured Theme -->
        <div class="mb-16">
          <div class="bg-[var(--ui-bg)] rounded-2xl shadow-lg overflow-hidden">
            <div class="md:flex">
              <div class="md:w-1/2">
                <div class="h-96 bg-gradient-to-br from-[var(--ui-bg-muted)] to-[var(--ui-border-muted)] flex items-center justify-center">
                  <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-[var(--ui-text-highlighted)]">Saya Theme</h3>
                    <p class="text-[var(--ui-text-muted)] mt-2">Elegant & Minimal</p>
                  </div>
                </div>
              </div>
              <div class="md:w-1/2 p-8">
                <div class="flex items-center justify-between mb-4">
                  <h2 class="text-3xl font-bold text-[var(--ui-text-highlighted)]">Saya</h2>
                  <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">Included</span>
                </div>
                ...
                <div class="space-y-3 mb-8">
                  <div class="flex items-center">
                    ...
                    <span class="text-[var(--ui-text)]">Mobile-first responsive design</span>
                  </div>
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                    <span class="text-stone-700">Google Business integration</span>
                  </div>
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                    <span class="text-stone-700">Visual content editor</span>
                  </div>
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                    <span class="text-[var(--ui-text)]">SEO optimized</span>
                  </div>
                </div>
        ...
        <!-- Coming Soon Themes -->
        <div>
          <h2 class="text-3xl font-bold text-[var(--ui-text-highlighted)] text-center mb-12">Coming Soon</h2>
          <div class="grid md:grid-cols-3 gap-8">
            <!-- Theme 2 -->
            <div class="bg-[var(--ui-bg)] rounded-2xl shadow-sm border border-[var(--ui-border)] overflow-hidden">
              <div class="h-48 bg-gradient-to-br from-amber-50 to-amber-100 flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-[var(--ui-text-highlighted)]">Modern</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-[var(--ui-text-highlighted)] mb-2">Modern Theme</h3>
            ...
            <div class="bg-[var(--ui-bg)] rounded-2xl shadow-sm border border-[var(--ui-border)] overflow-hidden">
              <div class="h-48 bg-gradient-to-br from-emerald-50 to-emerald-100 flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-[var(--ui-text-highlighted)]">Rustic</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-[var(--ui-text-highlighted)] mb-2">Rustic Theme</h3>
                <p class="text-[var(--ui-text-muted)] mb-4">
            ...
            <div class="bg-[var(--ui-bg)] rounded-2xl shadow-sm border border-[var(--ui-border)] overflow-hidden">
              <div class="h-48 bg-gradient-to-br from-indigo-50 to-indigo-100 flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-[var(--ui-text-highlighted)]">Fusion</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-[var(--ui-text-highlighted)] mb-2">Fusion Theme</h3>
                <p class="text-[var(--ui-text-muted)] mb-4">
                  Contemporary design blending Eastern and Western aesthetics for fusion cuisine.
                </p>
                <div class="flex items-center justify-between">
                  <span class="text-[var(--ui-text-dimmed)] text-sm">{{ releaseLabels.fusion }}</span>
                  <UButton variant="outline" size="sm" disabled>Notify Me</UButton>
                </div>
              </div>
            </div>
        ...
        <!-- Features -->
        <div class="mt-20 bg-[var(--ui-bg)] rounded-2xl p-8">
          <h2 class="text-3xl font-bold text-[var(--ui-text-highlighted)] text-center mb-12">All Themes Include</h2>
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center">
              <div class="w-12 h-12 bg-black rounded-xl mx-auto mb-4 flex items-center justify-center">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 class="font-semibold text-[var(--ui-text-highlighted)] mb-2">Mobile Responsive</h3>
              <p class="text-[var(--ui-text-muted)] text-sm">Looks perfect on all devices</p>
            </div>
            <div class="text-center">
              <div class="w-12 h-12 bg-black rounded-xl mx-auto mb-4 flex items-center justify-center">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 class="font-semibold text-[var(--ui-text-highlighted)] mb-2">Visual Editor</h3>
              <p class="text-[var(--ui-text-muted)] text-sm">Easy drag-and-drop editing</p>
            </div>
            <div class="text-center">
              <div class="w-12 h-12 bg-black rounded-xl mx-auto mb-4 flex items-center justify-center">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 class="font-semibold text-[var(--ui-text-highlighted)] mb-2">SEO Optimized</h3>
              <p class="text-[var(--ui-text-muted)] text-sm">Built for search engines</p>
            </div>
            <div class="text-center">
              <div class="w-12 h-12 bg-black rounded-xl mx-auto mb-4 flex items-center justify-center">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 class="font-semibold text-[var(--ui-text-highlighted)] mb-2">Fast Loading</h3>
              <p class="text-[var(--ui-text-muted)] text-sm">Optimized for speed</p>
            </div>
          </div>
        </div>
      </div>
