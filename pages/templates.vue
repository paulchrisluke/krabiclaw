    ...
    <div class="container mx-auto px-4 py-16">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
          <h1 class="text-5xl font-bold text-(--ui-text-highlighted) mb-6">Beautiful Restaurant Themes</h1>
        ...
        <!-- Featured Theme -->
        <div class="mb-16">
          <div class="bg-(--ui-bg) rounded-2xl shadow-lg overflow-hidden">
            <div class="md:flex">
              <div class="md:w-1/2">
                <div class="h-96 bg-gradient-to-br from-stone-100 to-stone-200 flex items-center justify-center">
                  <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-(--ui-text-highlighted)">Saya Theme</h3>
              ...
              <div class="md:w-1/2 p-8">
                <div class="flex items-center justify-between mb-4">
                  <h2 class="text-3xl font-bold text-(--ui-text-highlighted)">Saya</h2>
                ...
                <div class="space-y-3 mb-8">
                  <div class="flex items-center">
                    ...
                    <span class="text-stone-700">Mobile-first responsive design</span>
                  </div>
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
        ...
        <!-- Coming Soon Themes -->
        <div>
          <h2 class="text-3xl font-bold text-(--ui-text-highlighted) text-center mb-12">Coming Soon</h2>
          <div class="grid md:grid-cols-3 gap-8">
            <!-- Theme 2 -->
            <div class="bg-(--ui-bg) rounded-2xl shadow-sm border border-(--ui-border) overflow-hidden">
              <div class="h-48 bg-gradient-to-br from-amber-50 to-amber-100 flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-(--ui-text-highlighted)">Modern</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-(--ui-text-highlighted) mb-2">Modern Theme</h3>
            ...
            <div class="bg-(--ui-bg) rounded-2xl shadow-sm border border-(--ui-border) overflow-hidden">
              <div class="h-48 bg-gradient-to-br from-emerald-50 to-emerald-100 flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-(--ui-text-highlighted)">Rustic</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-(--ui-text-highlighted) mb-2">Rustic Theme</h3>
                <p class="text-(--ui-text-muted) mb-4">
            ...
            <div class="bg-(--ui-bg) rounded-2xl shadow-sm border border-(--ui-border) overflow-hidden">
              <div class="h-48 bg-gradient-to-br from-indigo-50 to-indigo-100 flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-(--ui-text-highlighted)">Fusion</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-(--ui-text-highlighted) mb-2">Fusion Theme</h3>
                <p class="text-(--ui-text-muted) mb-4">
        ...
        <!-- Features -->
        <div class="mt-20 bg-(--ui-bg) rounded-2xl p-8">
          <h2 class="text-3xl font-bold text-(--ui-text-highlighted) text-center mb-12">All Themes Include</h2>
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text-highlighted) mb-2">Mobile Responsive</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text-highlighted) mb-2">Visual Editor</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text-highlighted) mb-2">SEO Optimized</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text-highlighted) mb-2">Fast Loading</h3>
              <p class="text-(--ui-text-muted) text-sm">Optimized for speed</p>
            </div>
          </div>
        </div>
      </div>
