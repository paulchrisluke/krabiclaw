  ...
  <div class="container mx-auto px-4 py-16">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
          <h1 class="text-5xl font-bold text-(--ui-text) mb-6">Beautiful Restaurant Themes</h1>
        ...
        <!-- Featured Theme -->
        <div class="mb-16">
          <div class="bg-(--ui-bg-elevated) rounded-2xl shadow-lg overflow-hidden border border-(--ui-border)">
            <div class="md:flex">
              <div class="md:w-1/2">
              ...
              <div class="md:w-1/2 p-8">
                <div class="flex items-center justify-between mb-4">
                  <h2 class="text-3xl font-bold text-(--ui-text)">Saya</h2>
                ...
                <div class="space-y-3 mb-8">
                  <div class="flex items-center">
                    ...
                    <span class="text-(--ui-text)">Mobile-first responsive design</span>
                  </div>
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-(--kc-teal) mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                    <span class="text-(--ui-text)">Google Business integration</span>
                  </div>
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-(--kc-teal) mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                    <span class="text-(--ui-text)">Visual content editor</span>
                  </div>
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-(--kc-teal) mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
        ...
        <!-- Coming Soon Themes -->
        <div>
          <h2 class="text-3xl font-bold text-(--ui-text) text-center mb-12">Coming Soon</h2>
          <div class="grid md:grid-cols-3 gap-8">
            <!-- Theme 2 -->
            <div class="bg-(--ui-bg-elevated) rounded-2xl shadow-sm border border-(--ui-border) overflow-hidden">
              <div class="h-48 bg-(--ui-bg-muted) flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-(--ui-text)">Modern</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-(--ui-text) mb-2">Modern Theme</h3>
                <p class="text-(--ui-text-muted) mb-4">
                  Bold design with vibrant colors and dynamic layouts perfect for contemporary restaurants.
                </p>
                <div class="flex items-center justify-between">
                  <span class="text-(--ui-text-dimmed) text-sm">{{ releaseLabels.modern }}</span>
            ...
            <div class="bg-(--ui-bg-elevated) rounded-2xl shadow-sm border border-(--ui-border) overflow-hidden">
              <div class="h-48 bg-(--ui-bg-muted) flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-(--ui-text)">Rustic</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-(--ui-text) mb-2">Rustic Theme</h3>
                <p class="text-(--ui-text-muted) mb-4">
                  Warm, traditional design perfect for farm-to-table and family-style restaurants.
                </p>
                <div class="flex items-center justify-between">
                  <span class="text-(--ui-text-dimmed) text-sm">{{ releaseLabels.rustic }}</span>
                  <UButton variant="outline" size="sm" disabled>Notify Me</UButton>
                </div>
              </div>
            </div>
            ...
            <div class="bg-(--ui-bg-elevated) rounded-2xl shadow-sm border border-(--ui-border) overflow-hidden">
              <div class="h-48 bg-(--ui-bg-muted) flex items-center justify-center">
                <div class="text-center">
                  ...
                  <h3 class="text-lg font-bold text-(--ui-text)">Fusion</h3>
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-xl font-bold text-(--ui-text) mb-2">Fusion Theme</h3>
                <p class="text-(--ui-text-muted) mb-4">
                  Contemporary design blending Eastern and Western aesthetics for fusion cuisine.
                </p>
                <div class="flex items-center justify-between">
                  <span class="text-(--ui-text-dimmed) text-sm">{{ releaseLabels.fusion }}</span>
                  <UButton variant="outline" size="sm" disabled>Notify Me</UButton>
                </div>
              </div>
            </div>
        ...
        <!-- Features -->
        <div class="mt-20 bg-(--ui-bg-elevated) rounded-2xl border border-(--ui-border) p-8">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text) mb-2">Mobile Responsive</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text) mb-2">Visual Editor</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text) mb-2">SEO Optimized</h3>
            ...
            <div class="text-center">
              ...
              <h3 class="font-semibold text-(--ui-text) mb-2">Fast Loading</h3>
