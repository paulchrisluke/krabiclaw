...
const detailsPath = computed(() => `/dashboard/${String(route.params.orgSlug)}/sites/${String(route.params.siteSlug)}/locations/${String(route.params.locationSlug)}/messages/${encodeURIComponent(threadId.value)}/details`)
