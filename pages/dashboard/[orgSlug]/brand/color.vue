<template>
  ...
  >
    <div class="space-y-8">
      <UColorPicker v-model="editor.form.brand_color" format="hex" size="xl" class="w-full" />
      <UFormField label="Hex color">
        <UInput v-model="editor.form.brand_color" maxlength="7" placeholder="#0f766e" size="xl" class="w-full" />
      </UFormField>
    </div>
