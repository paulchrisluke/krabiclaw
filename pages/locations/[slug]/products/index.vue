...
useSocialMetadata(() => ({ path: `/locations/${encodeURIComponent(currentLocation.slug)}/products`, title: `${locationTitle} Products`, description: `Products at ${locationTitle}.`, brand: { siteName: brandName } }))
</script>
