<template>
  <ProductCollectionPage :products="products" :locations="productLocations" :currency="currency" :presentation="presentation" :vertical="vertical" :title="`${brandName} Products`" />
</template>
...
useSocialMetadata(() => ({ path: presentation.collectionPath, title: `${brandName} Products`, description: `Products from ${brandName}.`, label: presentation.collectionLabel, brand: { siteName: brandName }, ownerType: 'site', ownerId: `${siteId}:products` }))
</script>
