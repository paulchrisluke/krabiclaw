...
- Org-level settings (general/domains/members/billing) are intentionally distinct from site settings (brand, navigation, footer, SEO, analytics and site-wide integrations) and location settings (profile, address, hours, notifications and location integrations). Each has its own canonical route under the explicit organization/site/location hierarchy.
