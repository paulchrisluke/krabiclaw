...
CREATE TABLE `__new_site_conversion_events` (
	...
	CONSTRAINT "site_conversion_events_name_check" CHECK(event_name IN ('page_view', 'book_consultation_click', 'contact_submit', 'donation_click'))
);
...
ALTER TABLE `contact_submissions` ADD `consent_at` text;