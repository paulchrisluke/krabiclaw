...
ALTER TABLE `business_locations` ADD `og_image_asset_id` text REFERENCES media_assets(id);--> statement-breakpoint
...
ALTER TABLE `experiences` ADD `og_image_asset_id` text REFERENCES media_assets(id);--> statement-breakpoint
...
ALTER TABLE `menu_items` ADD `og_image_asset_id` text REFERENCES media_assets(id);--> statement-breakpoint
