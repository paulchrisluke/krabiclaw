...
Mining misses intent that hasn't come up yet. Use the harness's structured user-input tool when available rather than asking the user to type from scratch. Lower cognitive load, higher hit rate.
...
- The **superdev-mode** skill: example of the output shape.
- The **unslop** skill: prose discipline for every line.
- The active harness's skill-authoring guidance: skill authoring process and writing rules.
