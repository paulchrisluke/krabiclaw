...
Use this playbook to review a proposal, architecture, plan, diff, or implementation. The playbook is self-contained. Do not require another skill or reference file to complete the review.
