...
Stop here and wait for the user's explicit choice. You may recommend a variation and explain why, but the user chooses the winner or combination. Do not promote a variation, remove the others, clean up the prototype, or resolve or close its ticket before the user decides.

### 6. Capture the answer and clean up

After the user explicitly chooses a winner or combination, capture the answer (which variant and why), then capture the prototype the way the [SKILL](SKILL.md) describes. Fold the user's choice into the real code and move the rest onto the throwaway branch, not into main:
