...
This skill provides syntax, testing technique, and vendor reference material for documentation planning. It does not authorize new architecture, dependencies, infrastructure, abstractions, schema, routes, resources, or workflows.
