...
Spawn a single general-purpose subagent through the active harness's delegation interface that explores and explains in one pass:
...
Once all explorers return, spawn a single general-purpose subagent through the active harness's delegation interface to synthesize their findings into one coherent explanation:
