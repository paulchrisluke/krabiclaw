...
const baselineSql = readFileSync('migrations/0000_epoch_3_baseline.sql', 'utf8')
const billingSource = readFileSync('server/utils/billing-entitlements.ts', 'utf8')

test('epoch-3 baseline creates the canonical review request schema', () => {
...
test('epoch-3 baseline includes the complete review request domain', () => {
