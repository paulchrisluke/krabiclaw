...
test('navbar leading resolves detail back then mobile scope back without duplicating sidebar controls', () => {
...
test('sidebar collapse belongs to the desktop sidebar header', () => {
  ...
  assert.match(scopeHeader, /<DashboardSidebarCollapseButton \/>/)
  assert.doesNotMatch(navbarLeading, /DashboardSidebarCollapseButton/)
