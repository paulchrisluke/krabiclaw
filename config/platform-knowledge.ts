...
export const PLATFORM_KNOWLEDGE_PAGE_ENTRIES: PlatformKnowledgePageEntry[] = [
  ...
  },
  {
    ...
    section: 'Platform',
    keywords: ['templates', 'themes', 'design', 'saya', 'layouts'],
    surfaces: ['public', 'docs', 'blog', 'help', 'chowbot'],
  },
]
...
export const PLATFORM_DASHBOARD_ROUTE_ENTRIES: PlatformDashboardRouteEntry[] = [
  ...
  },
  {
    ...
    icon: 'globe',
    section: 'Settings',
    keywords: ['domains', 'custom domain', 'dns', 'ssl'],
    surfaces: ['dashboard'],
  },
  {
  ...
  },
  {
    ...
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/content',
    fallbackPath: '/dashboard',
  ...
  },
  {
    id: 'location-menu',
    title: 'Menu',
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/menu',
    fallbackPath: '/dashboard',
  ...
  },
  {
    ...
    title: 'Experiences',
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/experiences',
    fallbackPath: '/dashboard',
  ...
  },
  {
    id: 'location-media',
    title: 'Media Library',
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/media',
    fallbackPath: '/dashboard',
    snippet: 'Search and manage media assets for the current location.',
    body: 'Media library includes file search, uploads, and asset management for customer-facing content.',
    icon: 'images',
    section: 'Location',
    keywords: ['media', 'photos', 'images', 'files'],
    surfaces: ['dashboard'],
  },
  {
    id: 'location-photos',
    title: 'Photos',
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/photos',
    fallbackPath: '/dashboard',
  ...
  },
  {
    id: 'location-inbox',
    title: 'Inbox',
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/inbox',
    fallbackPath: '/dashboard',
    snippet: 'Review submissions and inbound requests.',
    body: 'Inbox covers contact submissions and customer-facing inbound requests for the location.',
    icon: 'inbox',
    section: 'Operations',
  ...
  },
  {
    id: 'location-reviews',
    title: 'Reviews',
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/reviews',
    fallbackPath: '/dashboard',
    snippet: 'Review imported reviews and related site display.',
    body: 'Reviews covers review ingestion, visibility, and customer trust content.',
    icon: 'star',
    section: 'Operations',
    keywords: ['reviews', 'ratings', 'google reviews'],
    surfaces: ['dashboard'],
  },
  {
    id: 'location-reservations',
    title: 'Reservations',
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/reservations',
    fallbackPath: '/dashboard',
  ...
  },
  {
    ...
    pathTemplate: '/dashboard/:orgSlug/sites/:siteSlug/:locationSlug/analytics',
    fallbackPath: '/dashboard',
