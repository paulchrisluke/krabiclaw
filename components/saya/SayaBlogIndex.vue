  ...
  <div class="min-h-screen bg-default text-default">
    ...
    <div v-else-if="posts.length === 0" class="py-24 text-center text-muted">
      ...
      <div v-else class="flex flex-col gap-12">
        <BlogSearchBox class="max-w-md" placeholder="Search stories..." />
        ...
        <section
          ...
          class="scroll-mt-28"
        >
          <h2 class="mb-6 text-2xl font-bold text-default">{{ group.category }}</h2>
...
const { categories } = useTenantBlogNav(posts)
