...
// Shared by pages/contact/index.vue (English, matched directly by Nuxt's
// file router) and the locale-prefixed catch-all (pages/[...tenantPath].vue,
// fallback branch for the 'contact' recipe) - same reasoning as
// components/tenant-pages/LocationQaPage.vue: a route alias can't carry the
// locale-prefixed path through Nuxt's file router.
