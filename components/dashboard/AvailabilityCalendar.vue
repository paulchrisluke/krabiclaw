...
async function loadMonth(key: string, generation = requestGeneration.value): Promise<void> {
  ...
  try {
    const response = await dashboardApi<AvailabilityCalendar>(
      `/api/editor/organizations/${props.organizationId}/locations/${props.locationId}/reservation-availability`,
...
async function saveSelection(): Promise<void> {
  ...
  saveError.value = null
  try {
    await dashboardApi(`/api/editor/organizations/${props.organizationId}/locations/${props.locationId}/reservation-availability`, {
      method: 'PUT',
      body: { changes },
