<template>
  <section class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <h1 class="mt-4 font-display text-5xl text-[var(--blawby-primary)]">Legal Services Offered</h1>
    ...
    <div v-if="offerings.length" class="mt-12 grid gap-6 md:grid-cols-2">
      ...
      >
        ...
        <div>
          <h2 class="font-display text-3xl text-[var(--blawby-primary)]">{{ offering.name }}</h2>
