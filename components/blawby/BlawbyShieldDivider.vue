...
const props = defineProps<{ variant: BlawbyShieldVariant }>()
...
const fill = computed(() => {
  if (props.variant === 'schedule') return 'var(--blawby-primary-800)'
  if (props.variant === 'about' || props.variant === 'contact') return 'var(--blawby-accent-200)'
