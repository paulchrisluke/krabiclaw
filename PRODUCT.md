...
- Scope: `tenant`
- MCP capabilities cover site setup, locations, menus, experiences, posts, media, locale management, Google Places, Facebook, analytics, and work requests. The generated catalog is authoritative.
